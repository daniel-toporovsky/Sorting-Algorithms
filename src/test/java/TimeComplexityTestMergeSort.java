...
public class TimeComplexityTestMergeSort {
    ...
    public static void main(String[] args) {
        ...
        for (int size : sizes) {
            ...
            long startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(randomInputInt);
            long endTime = System.nanoTime();
            long randomTimeIntMergeSortNoRecursion = endTime - startTime;

            startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(randomInputLong);
            endTime = System.nanoTime();
            long randomTimeLongMergeSortNoRecursion = endTime - startTime;

            startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(sortedInputInt);
            endTime = System.nanoTime();
            long sortedTimeIntMergeSortNoRecursion = endTime - startTime;

            startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(sortedInputLong);
            endTime = System.nanoTime();
            long sortedTimeLongMergeSortNoRecursion = endTime - startTime;

            startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(nearlySortedInputInt);
            endTime = System.nanoTime();
            long nearlySortedTimeIntMergeSortNoRecursion = endTime - startTime;

            startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(nearlySortedInputLong);
            endTime = System.nanoTime();
            long nearlySortedTimeLongMergeSortNoRecursion = endTime - startTime;

            startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(reverseSortedInputInt);
            endTime = System.nanoTime();
            long reverseSortedTimeIntMergeSortNoRecursion = endTime - startTime;

            startTime = System.nanoTime();
            Sorter.mergeSortNoRecursion(reverseSortedInputLong);
            endTime = System.nanoTime();
            long reverseSortedTimeLongMergeSortNoRecursion = endTime - startTime;

            // Analyze results (print or plot the data)
            DecimalFormat formatter = new DecimalFormat("#,###,###");
            // RANDOM INT
            System.out.println("Size: " + size);
            System.out.println("Random Input Time: randomInputIntTime`: " + formatter.format(randomTimeIntMergeSortNoRecursion /100) + " ms");
            ...
            // RANDOM LONG
            System.out.println("Random Input Time: randomInputLongTime`: " + formatter.format(randomTimeLongMergeSortNoRecursion /100) + " ms");
            ...
            // SORTED INT
            System.out.println("Random Input Time: sortedInputIntTime`: " + formatter.format(sortedTimeIntMergeSortNoRecursion /100) + " ms");
            ...
            // SORTED LONG
            System.out.println("Random Input Time: sortedInputLongTime`: " + formatter.format(sortedTimeLongMergeSortNoRecursion /100) + " ms");
            ...
            //NEARLY SORTED INT
            System.out.println("Random Input Time: nearlySortedInputIntTime`: " + formatter.format(nearlySortedTimeIntMergeSortNoRecursion /100) + " ms");
            ...
            //NEARLY SORTED LONG
            System.out.println("Random Input Time: nearlySortedInputLongTime`: " + formatter.format(nearlySortedTimeLongMergeSortNoRecursion /100) + " ms");
            ...
            //REVERSE SORTED INT
            System.out.println("Random Input Time: reverseSortedInputIntTime`: " + formatter.format(reverseSortedTimeIntMergeSortNoRecursion /100) + " ms");
            ...
            //REVERSE SORTED LONG
            System.out.println("Random Input Time: reverseSortedInputLongTime`: " + formatter.format(reverseSortedTimeLongMergeSortNoRecursion /100) + " ms");
